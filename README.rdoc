...
* rake ts:index 
* foreman start
*!!!!! I dont know why but it just don't work adding bundle exec sidekiq into foreman. Since that you have to run it manually --  bundle exec sidekiq -- If you don't mind please help me to get through this issue. 
